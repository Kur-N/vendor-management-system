                                                ...
                                                onAfterSelect: function (id) {
                                                    ...
                                                    if ($$('branchSetup')) {
                                                        ...
                                                        $$('branchSetup').parse({
                                                            _id: selectedId,
                                                            createDate:
                                                                selectedItem.setup.createDate,
                                                            createUser:
                                                                selectedItem.setup.createUser,
                                                            updateUser:
                                                                selectedItem.setup.updateUser,
                                                            updateDate:
                                                                selectedItem.setup.updateDate,
                                                        });
                                                    }
                                                    if ($$('btnClearEdit')) {
                                                        $$('btnClearEdit').attachEvent(
...
webix.ready(function () {
    ...
    if ($$('btnInfo')) {
        $$('btnInfo').attachEvent('onItemClick', function () {
            let selectedId = $$('vendorDataview') ? $$('vendorDataview').getSelectedId() : null;
            if (!selectedId) {
                webix.message({
                    type: 'error',
    ...
    if ($$('btnEditBranch')) {
        $$('btnEditBranch').attachEvent('onItemClick', function () {
            ...
            if (selectedItem) {
                ...
                if ($$('editBranchForm')) $$('editBranchForm').setValues(selectedItem, true);

                if ($$('btnEditBranch2')) {
                    $$('btnEditBranch2').attachEvent('onItemClick', function () {
                        let values = $$('editBranchForm') ? $$('editBranchForm').getValues() : {};
                        let message = 'Isi Form sesuai dengan ketentuan';
